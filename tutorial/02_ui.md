...
* 13.1 Change the gravatar field in the table on the employees page to display the photo.
* 13.1 Change the gravatar field in the form on the employees page to display the photo.
* 13.2 The image in the table is to large. Make it smaller
* 13.3 Image in form is to small, make it bigger
* 13.4 Add icons to the buttons

### Hints:

* 13.1 Use an image to display the image
* 13.1 Set the source to the el expression you used for output before.
* 13.2 Change properties to resize the image
* 13.4 Icons can be found at http://www.famfamfam.com/lab/icons/silk/
